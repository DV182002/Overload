...
void OvEditor::Panels::AssetProperties::CreateHeaderButtons()
{
    ...
    m_applyButton->ClickedEvent += [this] { Apply(); };
...
void OvEditor::Panels::AssetProperties::CreateInfo()
{
    ...
    if (std::filesystem::exists(realPath))
    {
        ...
        auto [size, unit] = OvTools::Utils::SizeConverter::ConvertToOptimalUnit(static_cast<float>(std::filesystem::file_size(realPath)), OvTools::Utils::SizeConverter::ESizeUnit::BYTE);
